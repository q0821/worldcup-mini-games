...
const DICT = {
  zh: {
    ...
    pkKickNo: '第 {n} 球',
    pkSudden: '驟死賽',
    pkAimDir: '箭頭左右擺，點一下定方向',
    pkLockPower: '力道條來回跑，抓甜蜜區點一下',
    pkAimCurve: '彎曲來回變，點一下定曲球弧度',
  ...
  en: {
    ...
    pkAimDir: 'Arrow swings — tap to set direction',
    pkLockPower: 'Power bar oscillates — tap in the sweet zone',
    pkAimCurve: 'Curve bends — tap to set the curl',
