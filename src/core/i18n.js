...
const DICT = {
  zh: {
    ...
    pkKickNo: '第 {n} 球',
    pkSudden: '驟死賽',
    pkYouShoot: '你射門：拖曳瞄準，放開出腳',
    pkYouKeep: '你撲救：點球門位置飛撲',
    pkShootCue: '對方準備射門…',
    pkStraight: '直射',
    pkBanana: '香蕉球',
    pkGoalScored: '進球！',
  ...
  en: {
    ...
    pkYouShoot: 'Your shot: drag to aim, release to shoot',
    pkYouKeep: "You're in goal: tap where to dive",
    pkShootCue: 'Shooter lining up...',
    pkStraight: 'Straight',
    pkBanana: 'Curler',
    pkGoalScored: 'GOAL!',
    pkSavedByCpu: 'Saved!',
